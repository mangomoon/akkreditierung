 ...
 */
class StaticStammdatenTest extends UnitTestCase
{
    /**
     * @var \GeorgRinger\Ieb\Domain\Model\StaticStammdaten|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GeorgRinger\Ieb\Domain\Model\StaticStammdaten::class,
            ['dummy']
        );
    }
