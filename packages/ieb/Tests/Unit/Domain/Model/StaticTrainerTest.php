 ...
 */
class StaticTrainerTest extends UnitTestCase
{
    /**
     * @var \GeorgRinger\Ieb\Domain\Model\StaticTrainer|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \GeorgRinger\Ieb\Domain\Model\StaticTrainer::class,
            ['dummy']
        );
    }
     ...
     * @test
     */
    public function getLehrBefugnisDateiReturnsInitialValueForString(): void
    {
        self::assertSame(
            '',
     ...
     * @test
     */
    public function setLehrBefugnisDateiForStringSetsLehrBefugnisDatei(): void
    {
        $this->subject->setLehrBefugnisDatei('Conceived at T3CON10');

        self::assertEquals('Conceived at T3CON10', $this->subject->_get('lehrBefugnisDatei'));
    }
     ...
     * @test
     */
    public function setBasedOnForTrainerSetsBasedOn(): void
    {
        $basedOnFixture = new \GeorgRinger\Ieb\Domain\Model\Trainer();
