...
return [
    'ctrl' => [
        ...
        'searchFields' => 'vorname,nachname,telefon,email',
        'iconfile' => 'EXT:ieb/Resources/Public/Icons/tx_ieb_domain_model_angebotverantwortlich.gif'
    ],
    'types' => [
        '1' => ['showitem' => 'vorname, nachname, telefon, email, verantwortlich, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:language, sys_language_uid, l10n_parent, l10n_diffsource, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:access, hidden, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_ieb_domain_model_angebotverantwortlich}.{#pid}=###CURRENT_PID### AND {#tx_ieb_domain_model_angebotverantwortlich}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
