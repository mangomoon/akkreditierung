...
return [
    ...
    'columns' => [
        ...
        'status_after_review' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.status_after_review',
            'description' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.status_after_review.description',
            'config' => [
                'type' => 'input',
                'size' => 4,
                'eval' => 'int',
