...
return [
    ...
    'columns' => [
        ...
        'review_comment_internal' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.review_comment_internal',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
        ...
        'review_comment_tr' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.review_comment_tr',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
        ...
        'review_status' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.review_status',
            'config' => [
                'type' => 'select',
        ...
        'based_on' => [
            'exclude' => true,
            'label' => 'LLL:EXT:ieb/Resources/Private/Language/locallang_db.xlf:tx_ieb_domain_model_trainer.based_on',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
